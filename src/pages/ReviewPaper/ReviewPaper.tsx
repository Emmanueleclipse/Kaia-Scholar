...
import { dummyApiPapers } from '../BrowseScreen/BrowseScreen.demo';
...
export default function ReviewPaper() {
    ...
    useEffect(() => {
        if(user.isDemo){
            ...
            if(user.username.toLowerCase()==="user2"){
                setReviewer(true);
            }else{
                setNotReviewer(true);
            }
            ...
            <>
                <Container maxW='7xl'>
                    <Flex justifyContent="flex-start" >
                        ...
                        <Flex mt="2rem">
                            <PaperView file={paper?.ipfsHash} setPages={(pages) => setPages(pages)} />
                        </Flex>
                    </Flex>
                </Container>
            </>
